...
2. Choose name of your app, create local DB using it and then update settings.py and 
pyproject.toml(or local env will be created with default name) using the same name.
